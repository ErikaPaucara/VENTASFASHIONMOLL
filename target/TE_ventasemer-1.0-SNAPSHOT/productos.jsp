...
<html lang="es">
    ...
    <body>
        <div class="container"> 
            ...
            <br>
            <a href="ProductoControlador?action=add" class="btn btn-primary btn-sm  "><i class="fa-solid fa-user-plus"></i> Nuevo</a>
            <h1>Productos</h1>
            <table  class="table table-striped">
                ...
                <c:forEach var="item" items="${productos}">
                    <tr>
                        ...
                        <td><a href="ProductoControlador?action=delete&id=${item.id}" onclick="return(confirm('esta seguro de borrar'))">
